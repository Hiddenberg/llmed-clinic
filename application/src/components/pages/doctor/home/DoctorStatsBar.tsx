import {
   Calendar, CheckCircle, AlertTriangle, TrendingUp, Clock
} from 'lucide-react';
import { getDoctorStats } from '@/data/mockData/doctorData';
...
export default function DoctorStatsBar () {
      ...
      <div className="space-y-4">
         ...
         <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
               <div className="bg-gradient-to-r from-brand-600 to-blue-600 shadow-sm p-1.5 rounded-md">
                  <Calendar size={16} className="drop-shadow-sm text-white" />
               </div>
               <div>
                  <h2 className="bg-clip-text bg-gradient-to-r from-gray-800 to-gray-600 font-semibold text-transparent text-lg">
                     Resumen del Día
                  </h2>
                  <p className="text-gray-600 text-xs">Estado de citas y pacientes</p>
               </div>
            </div>

            <div className="flex items-center gap-2 bg-blue-50 px-3 py-1 border border-blue-200/50 rounded-full">
               <div className="relative">
                  <div className="bg-blue-500 rounded-full w-1.5 h-1.5 animate-pulse" />
                  <div className="absolute inset-0 bg-blue-400 rounded-full w-1.5 h-1.5 animate-ping" />
               </div>
               <span className="font-medium text-blue-700 text-xs">Actualizado</span>
            </div>
         </div>
