             ...
             <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                   ...
                   <XAxis 
                      ...
                      label={{ value: 'Tiempo (meses)', position: 'insideBottom', offset: -10 }}
                   />
                   <YAxis 
                      domain={[40, 100]}
                      tick={{ fontSize: 12, fill: '#6b7280' }}
                      axisLine={{ stroke: '#e5e7eb' }}
                      label={{ value: 'Supervivencia (%)', angle: -90, position: 'insideLeft' }}
                   />
                   <YAxis 
                      yAxisId="right"
                      orientation="right"
                      ...
                      tick={{ fontSize: 12, fill: '#6b7280' }}
                      axisLine={{ stroke: '#e5e7eb' }}
                      label={{ value: 'Pacientes en Riesgo', angle: 90, position: 'insideRight' }}
                   />
                   <Tooltip 
                      contentStyle={{
