          ...
          <div className="mb-8">
             ...
             <div className="gap-6 grid grid-cols-1 lg:grid-cols-3">
                {data.map((treatment, index) => {
                   const radarMetrics = [
                      { subject: 'Efectividad', value: treatment.effectivenessScore, fullMark: 10 },
                      { subject: 'Kt/V', value: treatment.averageKtV * 6, fullMark: 10 },
                      { subject: 'URR', value: treatment.averageURR / 8, fullMark: 10 },
                      { subject: 'Seguridad', value: 10 - (treatment.complicationRate / 2), fullMark: 10 },
                      { subject: 'Calidad', value: 10 - (treatment.hospitalizations * 2.5), fullMark: 10 }
                   ];
                   ...
                   return (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg">
                         ...
                         <div className="h-64">
                            <ResponsiveContainer width="100%" height="100%">
                               <RadarChart data={radarMetrics} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
